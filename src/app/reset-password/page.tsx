  ...
  return (
    <div className="page">
      ...
      <style jsx>{`
        ...
        .card { width: min(520px, 100%); padding: clamp(16px, 3vw, 24px); border-radius: 20px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12); backdrop-filter: blur(24px); }
        ...
        button { margin-top: 12px; width: 100%; border: 0; border-radius: 999px; min-height: 44px; padding: 12px 16px; background: linear-gradient(90deg, #8b5cf6, #22d3ee); color: white; cursor: pointer; }
