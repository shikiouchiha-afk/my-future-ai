...
export default function SettingsPage() {
  ...
  const save = async () => {
    ...
    setMessage("Settings saved. Premium access remains active.");
  };
  ...
  return (
    <div className="page">
      ...
      <style jsx>{`
        .page { min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 24px; background: linear-gradient(135deg, #04030b, #0f172a 55%, #111827 100%); color: white; }
        .card { width: min(560px, 100%); padding: 24px; border-radius: 24px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12); backdrop-filter: blur(24px); }
